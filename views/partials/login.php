<div id="login" tabindex="-1"
    class="bg-black/50 fixed top-0 right-0 left-0 z-10 h-full items-center justify-center flex">
            ...
            <div class="p-5">
                ...
                <form method="POST"  class="w-full">
                    ...
                    <?php if(!empty($errorMessage)){
                      echo "<p class='text-red-500 m-1'> $errorMessage </p>";
                    }?>
                    <button type="submit"
                ...
                <div class="mt-6 text-center text-sm text-slate-600">
                    ...
                    <a class="font-medium text-[#4285f4]">Sign up</a>
                </div>
            </div>
        </div>
    </div>
