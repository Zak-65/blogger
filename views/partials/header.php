<header class="relative  flex items-center justify-between sm:h-10 md:justify-center py-6 px-4 mt-2 m-4">
    ...
    <div class="hidden md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
        ...
        <span  id="btnGetStarted" class="inline-flex rounded-md shadow ml-2">
            <a href="/signIn" class="inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out">
               Get started
            </a>
        </span>
    </div>
